...
/// Margin account type with borrowing privileges.
///
/// Represents a margin-enabled brokerage account with initial, current, and projected balance information.
/// Allows for leveraged trading and short selling.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct MarginAccount {
    #[serde(rename = "initialBalances", skip_serializing_if = "Option::is_none")]
    pub initial_balances: Option<Box<trader::MarginInitialBalance>>,
    #[serde(rename = "currentBalances", skip_serializing_if = "Option::is_none")]
    pub current_balances: Option<Box<trader::MarginBalance>>,
    #[serde(rename = "projectedBalances", skip_serializing_if = "Option::is_none")]
    pub projected_balances: Option<Box<trader::MarginBalance>>,
