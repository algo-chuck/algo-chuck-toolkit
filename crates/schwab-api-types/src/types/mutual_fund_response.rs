...
pub struct MutualFundResponse {
    ...
    pub asset_sub_type: Option<Option<types::MutualFundAssetSubType>>,
    /// SSID of instrument
    ...
    pub quote: Option<Box<types::QuoteMutualFund>>,
    #[serde(rename = "reference", skip_serializing_if = "Option::is_none")]
    pub reference: Option<Box<types::ReferenceMutualFund>>,
}
