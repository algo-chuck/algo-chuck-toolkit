...
pub struct InstrumentResponse {
    ...
    pub fundamental: Option<Box<marketdata::FundamentalInst>>,
    #[serde(rename = "instrumentInfo", skip_serializing_if = "Option::is_none")]
    pub instrument_info: Option<Box<marketdata::Instrument>>,
    #[serde(rename = "bondInstrumentInfo", skip_serializing_if = "Option::is_none")]
    pub bond_instrument_info: Option<Box<marketdata::Bond>>,
